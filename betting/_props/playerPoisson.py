...
def onePlayer(league, team, player, stat, value, bet_type):
    if league == 'NBA':
        ...
        if bet_type == 1:    
            ...
            # team, player, stat
            print('\n')
            print(str(player) + "'s count for " + str(stat) + ' = ' + str(count) + '/' + str(game_count))
...
onePlayer('NHL', 'Colorado', 'Nathan MacKinnon', 'goals', 0.5, 1)
onePlayer('NHL', 'Colorado', 'Gabriel Landeskog', 'goals', 0.5, 1)
onePlayer('NHL', 'Tampa Bay', 'Nikita Kucherov', 'goals', 0.5, 1)
onePlayer('NHL', 'Tampa Bay', 'Steven Stamkos', 'goals', 0.5, 1)
